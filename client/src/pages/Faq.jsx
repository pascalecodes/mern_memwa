...
export default function Faq() {
  return (
      ...
      <div className="container px-4 py-5 my-5">
        <h2 className='text-2xl text-blue-700'>What is Memwa?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-2'>How does Memwa work?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-2'>What languages are available on Memwa?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-2'>How much does Memwa cost?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-2'>How do I sign up for Memwa?</h2>
        <p>You can sign up for Memwa by visiting our website at www.memwa.app.</p>
        <h2 className='text-2xl text-blue-700 mt-2'>How to Create a Post</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-2'>What Can I Include in My  Post?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-2'>How to Share Your Post</h2>
