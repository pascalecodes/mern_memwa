  ...
  return (
    <div className='py-20 px-8 max-w-6xl mx-auto min-h-[20vh]'>
      ...
      <div className="container px-4 py-5 my-5">
        <h2 className='text-2xl text-blue-700 mt-4'>Welcome to Memwa Privacy Policy Page!</h2>
      ...
      <h2 className='text-2xl text-blue-700 mt-4'>We take your privacy seriously</h2>
      ...
      <h2 className='text-2xl text-blue-700 mt-4'>What data do we collect?</h2>
      ...
      <h2 className='text-2xl text-blue-700 mt-4'>How do we protect your data?</h2>
      ...
      <h2 className='text-2xl text-blue-700 mt-4'>What are your Data rights?</h2>
      ...
      <p>You can exercise your rights by contacting us at <span> </span>
       <Link 
        ...
        <h2 className='text-2xl text-blue-700 mt-4'>What Personal Information Do We Collect?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-4'>How Do We Use Your Personal Information?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-4'>How Do We Protect Your Personal Information?</h2>
        ...
        <p>We also have a team of security experts who are constantly working to keep your data safe.</p>
        <h2 className='text-2xl text-blue-700 mt-4'>What Are Your Personal Information Rights?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-4'>How Do We Handle Children's Privacy?</h2>
        ...
        <h2 className='text-2xl text-blue-700 mt-4'>How Do We Use Cookies?</h2>
